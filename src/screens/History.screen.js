                ...
                <FlatList
                    ...
                    renderItem={({item}) => (
                        <View style={{
                            ...
                            <View>
                                <Text>{this.state.retros[this.state.retros.length - 1].results[item.id]}</Text>
                            </View>
                            <View style={{marginLeft: 10}}>
                                {
                                    this.state.retros[this.state.retros.length - 1].results[item.id] > this.state.retros[this.state.retros.length - 2].results[item.id] ?
